 ...
 * notification/alert/workbench engines.
 */
class CommandCopyCoverageTest {
    ...
    fun `no screen hardcodes Persian text`() {
        ...
        val offenders = sourceDir!!.listFiles { f -> (f.name.startsWith("Command") || f.name == "ContextualHelp.kt" || f.name == "MonitorService.kt" || f.name == "MainActivity.kt" || f.name == "AlertEngine.kt" || f.name == "UptimeEngine.kt" || f.name == "ProxyEngine.kt" || f.name == "SftpEngine.kt") && f.name.endsWith(".kt") }
    ...
    fun `every key is actually rendered by a screen or notification`() {
        ...
        assumeTrue("source tree not reachable from the test working directory", sourceDir != null)
        val used = sourceDir!!.listFiles { f -> (f.name.startsWith("Command") || f.name == "ContextualHelp.kt" || f.name == "MonitorService.kt" || f.name == "MainActivity.kt" || f.name == "AlertEngine.kt" || f.name == "UptimeEngine.kt" || f.name == "ProxyEngine.kt" || f.name == "SftpEngine.kt" || f.name == "TunnelModel.kt") && f.name.endsWith(".kt") }
